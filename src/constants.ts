...
export const CHOOSE_WORD_READY = 'chooseWord@READY'
export const CHOOSE_WORD_SET_INDEX = 'chooseWord@SET_INDEX'
...
export const CHOOSE_WORD_SET_NEXT = 'chooseWord@SET_NEXT'
