...
import { WRITE_SENTENCE_INIT, WRITE_SENTENCE_SET_INPUT, WRITE_SENTENCE_NEXT, WRITE_SENTENCE_CHECK, WRITE_SENTENCE_LISTEN, WRITE_SENTENCE_STEP, WRITE_SENTENCE_STOP, WRITE_SENTENCE_SET_INDEX } from '../constants'
